...
public class Basic2 extends JFrame {
	...
	/**
		 ...
		 **/		 
	public Basic2( int rows, int cols, int scale) {
		super("Basic2 Display");
		...
		this.canvas = new Basic2Panel( height*scale, width*scale );
	...
	private class Basic2Panel extends JPanel {
		 ...
		 **/
		public Basic2Panel(int height, int width) {
			super();
